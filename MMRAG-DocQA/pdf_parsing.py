...
from mmrag_config import set_model_cache_env, get_openai_client, get_model_name
    ...
    def get_image_semantics(self, image_data):
        ...
        if self.llm_model:
            try:
                ...
                # Step 2: Generate type-specific description
                description_prompt = self._get_description_prompt(image_type)
